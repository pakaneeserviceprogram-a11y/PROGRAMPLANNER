...
อัปเดตล่าสุด: 2026-09-17 (แก้ไข/ลบรายการในหน้างานประจำ ออกกำลังกาย การเงิน เรียนรู้ ลูกค้า) — ใช้ไฟล์นี้เพื่อกลับมาทำงานต่อได้เร็ว ไม่ต้องไล่อ่านทั้งบทสนทนาใหม่
...
- **มุมมอง 4 แบบ** วัน / สัปดาห์ / เดือน / ปี (ปุ่มสลับย้ายลงมาเป็นแถวเต็มความกว้างใต้หัวข้อ เพราะ 4 ปุ่มไม่พอที่บนจอ 360dp)
  ...
  - **ข้อควรจำ**: ตารางยังเป็น "ประจำสัปดาห์" — ทุกวันจันทร์ในปฏิทินจึงเหมือนกัน ถ้าจะให้ต่างกันต้องเพิ่มนัดหมายเฉพาะวันที่ (ยังไม่ทำ)

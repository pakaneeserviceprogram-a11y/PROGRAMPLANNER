...
อัปเดตล่าสุด: 2026-09-19 (สแกนนามบัตร + นำเข้าสมุดโทรศัพท์ + แหล่งที่มาของลูกค้า) — ใช้ไฟล์นี้เพื่อกลับมาทำงานต่อได้เร็ว ไม่ต้องไล่อ่านทั้งบทสนทนาใหม่
...
- [ ] **ทดสอบบนมือถือจริง + build APK ด้วย release key** — ยังต้องทำบนเครื่องที่มี `lifeplan-release.jks` / `key.properties` (เครื่องนี้ไม่มี APK จึงเซ็นด้วย debug key)

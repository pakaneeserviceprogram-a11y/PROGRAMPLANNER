...
class VideoSearch {
  ...
  /// หัวข้อที่ตรงกับโมดูลในแอป (การเงิน ประกัน สุขภาพ ออกกำลังกาย เรียนรู้/พัฒนาตนเอง)
  /// และทักษะที่ผู้ใช้ขอเพิ่ม (การตลาด/การขาย ภาษา บุคลิกภาพ/การพูด)
  static const topics = <VideoTopic>[
    ...
    VideoTopic(label: 'การตลาด & การขาย', queries: [
      'เทคนิคปิดการขาย',
      'การตลาดออนไลน์สำหรับมือใหม่',
      'ยิงแอดเฟซบุ๊ก ทำโฆษณา',
      'เขียนคอนเทนต์ขายของ',
    ]),
    VideoTopic(label: 'สุขภาพ', queries: [
      'กินอย่างไรให้สุขภาพดี โภชนาการพื้นฐาน',
      'นอนหลับให้มีคุณภาพ',
      'ตรวจสุขภาพประจำปี อ่านผลเลือด',
    ]),
    VideoTopic(label: 'ออกกำลังกาย', queries: [
      'เวทเทรนนิ่งมือใหม่ ท่าพื้นฐาน',
      'คาร์ดิโอเผาผลาญที่บ้าน',
      'ยืดเหยียดแก้ปวดหลังออฟฟิศซินโดรม',
      'วิ่งเริ่มต้นสำหรับมือใหม่',
    ]),
    VideoTopic(label: 'เรียนภาษา', queries: [
      'ฝึกภาษาอังกฤษสำหรับที่ทำงาน',
      'ฝึกฟังภาษาอังกฤษจากศูนย์',
      'ภาษาอังกฤษสำหรับการนำเสนองาน',
      'เรียนภาษาญี่ปุ่นเบื้องต้น',
      'เรียนภาษาจีนพื้นฐาน พินอิน',
      'ภาษาจีนเพื่อการทำงาน HSK',
    ]),
    VideoTopic(label: 'บุคลิกภาพ & การพูด', queries: [
      'แต่งตัวให้ดูดี มืออาชีพ',
      'พัฒนาบุคลิกภาพ การวางตัว',
      'ฝึกพูดให้น่าฟัง ฝึกน้ำเสียง',
      'พูดในที่สาธารณะ ลดอาการประหม่า',
    ]),
